...
def main(args: argparse.Namespace) -> None:
    ...
    train_dataset = imagenet.ImageNet(root='./train', train=True, transform=ToTensor(), download=True)
    test_dataset = imagenet.ImageNet(root='./test', train=False, transform=ToTensor(), download=True)
