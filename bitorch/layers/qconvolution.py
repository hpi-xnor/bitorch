...
from torch.nn import _ConvNd
from . import layerconfig
from torch.nn.functional import pad, conv1d, conv2d, conv3d


class QConvolution(_ConvNd):
    """Abstract superclass for binary convolution"""
    ...
    def __init__(self, *args, quantization: str = None, padding_value: float = None, **kwargs) -> None:  # type: ignore
        ...
        """
        super(QConvolution, self).__init__(self, *args, **kwargs)
...
class QConvolution1D(QConvolution):
...
class QConvolution2D(QConvolution):
...
class QConvolution3D(QConvolution):
