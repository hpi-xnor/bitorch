...
class DummyDataset(object):
    ...
    def __init__(self, data_sample: Union[torch.Tensor, Tuple[torch.Tensor, torch.Tensor]], sample_count: int):
        self._data_sample = data_sample
        self._sample_count = sample_count
        self._count = 0

    def __iter__(self) -> "DummyDataset":
        return DummyDataset(self._data_sample, self._sample_count)
